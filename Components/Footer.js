...
const Footer = () => {
  return (
    <>
      <footer className="bg-[#f4faff] text-[#536274]">
        <div className="mx-auto grid w-full max-w-[1263px] grid-cols-[1.35fr_1fr_1fr_1.35fr] gap-12 px-6 py-16 max-md:grid-cols-2 max-md:gap-10 max-md:px-3">
          <div>
            <Image className="mb-5 h-auto w-[150px]" src="/logo.png" height={165} width={165} alt="Essa Laboratory" />
      ...
      <div className="fixed bottom-7 right-[34px] z-10 grid gap-[22px] max-md:bottom-4 max-md:right-[15px] max-md:gap-3" aria-label="Contact options">
        <a className="grid h-14 w-14 place-items-center rounded-full bg-[#0876d7] text-[27px] text-white shadow-[0_2px_5px_#a2a2a2] no-underline max-md:h-[46px] max-md:w-[46px] max-md:text-[21px]" href="tel:+9221111786986" aria-label="Call us">☎</a>
        <a className="grid h-14 w-14 place-items-center rounded-full bg-[#20cf68] text-[27px] text-white shadow-[0_2px_5px_#a2a2a2] no-underline max-md:h-[46px] max-md:w-[46px] max-md:text-[21px]" href="https://wa.me/9221111786986" aria-label="Chat on WhatsApp">◔</a>
      </div>
      </>
  )
}
