  ...
  return (
    <>
      ...
      <header className="mx-auto flex w-full max-w-[1263px] items-center justify-between gap-14 border-b border-[#e6e9ed] px-6 py-[22px] pb-4 max-md:gap-4 max-md:px-3 max-md:py-[15px]">
        <Image className="h-auto w-[165px] max-md:w-[105px]" src="/logo.png" height={165} width={165} alt="Essa Laboratory" />
      ...
      <nav className="mx-auto flex w-full max-w-[1263px] justify-center gap-[clamp(20px,4vw,58px)] overflow-x-auto whitespace-nowrap px-6 py-5 text-sm font-semibold max-md:justify-start max-md:gap-3.5 max-md:px-3 max-md:text-xs" aria-label="Main navigation">
        <a className="hover:text-[#096bc9]" href="#">Home</a><a className="hover:text-[#096bc9]" href="/About">About Us</a><a className="hover:text-[#096bc9]" href="/OnlineReports">Online Reports</a>
        <a className="hover:text-[#096bc9]" href="/LabTests">Lab Tests</a><a className="hover:text-[#096bc9]" href="/Packages">Packages</a><a className="hover:text-[#096bc9]" href="#">Mobile App</a>
      </nav>
      </>
  )
}
